...
test_that("bad palette name returns an error", {
  expect_error(extract_gradient("fake.palette"))
  expect_error(extract_gradient("fake.palette", n = 6))
  expect_error(extract_gradient("fake.palette", n = 6), regexp = "is not a recognised DfT gradient")
})
